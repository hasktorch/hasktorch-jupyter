...
RUN apt-get update -qq && \
	...
	jq emacs-nox vim strace curl unzip sudo && \
    wget -q https://github.com/hasktorch/libtorch-binary-for-ci/releases/download/1.11.0/libtorch_1.11.0+cu113-1_amd64.deb && \
...
RUN cd hasktorch && git checkout 0e942d6af90585662463c913acfbbe8036644cb1
...
RUN curl https://www.stackage.org/lts-17.6/cabal.config > cabal.config
